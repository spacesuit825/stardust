...
namespace STARDUST {
	...
	private:
		...
		void resolveCollisions(int n_collisions, CollisionManifold* d_collision_manifold_ptr, Hull* d_hull_ptr, float4* d_entity_force_ptr, float4* d_entity_torque_ptr, float4* d_vertex_ptr, int* d_indicies_ptr);
