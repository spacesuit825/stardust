// Portable GUI wrapper class exec

#include "guiwrapper.hpp"

// Initialize the wrapper around the GLFW window and set context and styles
...
// Renders the chosen GUI widgets into the GLFW window
...
GUIwrapper& GUIwrapper::addWidgetSliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
...
GUIwrapper& GUIwrapper::addWidgetInputFloat(const char* label, float* v, float step, float step_fast, const char* format, ImGuiInputTextFlags flags) {
...
GUIwrapper& GUIwrapper::addWidgetSliderFloat3(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
	auto func = [label, v, v_min, v_max, format, flags] {
